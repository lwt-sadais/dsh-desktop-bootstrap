...
| `dsh-git-history` | `0.1.2-alpha.1` | [`lwt-sadais/dsh-git-history`](https://github.com/lwt-sadais/dsh-git-history) | Git 历史与远端同步；仓库树显示本地未提交修改数量徽标；点击分支名弹出菜单切换分支（支持仅远程分支创建跟踪分支与 detached HEAD 附加）；分支菜单列举前先 fetch --prune 过滤远端已删分支 |
